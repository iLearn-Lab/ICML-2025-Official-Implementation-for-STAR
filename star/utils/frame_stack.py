"""
This wrapper preserves the older reset-padding behavior that STAR expects, while
remaining compatible with newer Gymnasium releases.

The upstream behavior difference is discussed here:
